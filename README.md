...
- [Identidad](docs/identidad/)
- [Razonamiento](docs/razonamiento/)
...
Este repositorio funciona como fuente oficial de conocimiento para Jorkcáceres y como base para asistentes de IA, sitio web, propuestas comerciales y futuras soluciones.
